          ...
          <div className="relative flex w-full flex-col justify-between px-8 py-10 xl:px-16 xl:py-14">
            ...
            <div className="max-w-xl">
              ...
              <p className="mt-6 text-base leading-7 text-slate-300">
                Enter the OTP sent to your email to activate your account and
                complete your registration process safely.
              </p>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-300">
                    Email verification ensures your account is activated
                    securely before login access is granted.
                  </p>
                </div>
              </div>
            </div>
