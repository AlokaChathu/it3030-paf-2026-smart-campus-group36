...
public interface BookingService {
    ...
    List<BookingResponse> getAllBookings(String resourceId, LocalDate date, BookingStatus status);
    ...
    List<TimeSlotResponse> getUnavailableSlots(String resourceId, LocalDate date);
}
